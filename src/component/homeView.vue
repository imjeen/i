...
<template>
	...
	<section>
		...
		<a href="#/own/info">个人中心</a>
		<ul>
			<li><a v-link="{path: '/own/ecard'}">电子会员卡</a></li>
			<li><a v-link="{path: '/track/list'}">我的足迹</a></li>
		</ul>
	</section>
	...
	<section>
		<p><a v-link="{path: '/own/activity'}" href="#">我的活动</a></p>
		<p><a v-link="{path: '/own/reservation'}" href="#">我的预约</a></p>
